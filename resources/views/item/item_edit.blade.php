...
<form action="{{action('ItemController@updateitem')}}" method="post">
							...
							<div class="row">						
																		...
																		<div class="col-lg-12">
																		  ...
																		  <select name="item_name" class="form-control select2" style="width: 100%;">
																				...
																				@foreach ($stock_name as $sn) 
																				  {
																					<option <?php if ($row->item_name == $sn) { echo 'selected="selected"';}?>>{{ $sn }}</option>
																				  }
																				@endforeach
																		  </select>
																		</div>
													...
													<div class="col-lg-6">
																	...
																	<label>Item Description</label>
																		<textarea name="item_desc" class="form-control" rows="8" placeholder="Item Description" style="overflow:auto;resize:none" ><?= $row->item_desc ?></textarea>
													</div>
													<div class="col-lg-6">
																	<br>
																	<div class="row">
																	...
																	<div class="row">
																		<div class="col-lg-4">
																		  <label><font color=red>*</font> Other Charges</label>
																			<input type="number" class="form-control" name="item_other_chrge" value="<?= $row->item_other_chrge ?>" placeholder="Other Charges">
																		</div>
																		<div class="col-lg-4">
																		  <label><font color=red>*</font> Discount</label>
																			<input type="number" class="form-control" name="item_disc" value="<?= $row->item_disc ?>" placeholder="Discount">
																		</div>
																		<div class="col-lg-4">
																		  <label>Total Price</label>
																			<input type="text" class="form-control" name="item_tot_price" value="<?= $row->item_tot_price ?>" placeholder="Total Price" readonly>
																		</div>
																	</div>
																	<br>
																	<div class="row">
																		<div class="col-lg-4">
																		  <label><font color=red>*</font> Total Cost</label>
																			<input type="number" class="form-control" name="item_tot_cost" value="<?= $row->item_tot_cost ?>" placeholder="Total Cost">
																		</div>
																		<div class="col-lg-4">
																		  <label>Profit</label>
																			<input type="text" class="form-control" name="item_profit" value="<?= $row->item_profit ?>" placeholder="Profit" readonly>
																		</div>
																	</div>
													</div>
							</div>
