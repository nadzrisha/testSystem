...
<body>
    ...
    <section class="content-header">
      <h1>
        Add Purchased Item Forms
      </h1>
    </section>
<section class="content">
<div class="form-group">
<form action="{{action('PurchDetController@save_purch_det')}}" method="post">
							...
							<div class="row">			
													...
													<div class="col-lg-6">
																	...
																	<label>Purchased Item Description</label>
																		<textarea name="pur_det_desc" class="form-control" rows="8" placeholder="Purchased Item Description" style="overflow:auto;resize:none" >{{ old('item_desc') }}</textarea>
													</div>
																	...
																	<div class="row">
																		<div class="col-xs-12">
																		  <label><font color=red>*</font> Purchased Item Price</label>
																			<input type="number" class="form-control" value="0" name="pur_det_price" placeholder="Purchased Item Price">
																		</div>
																	</div>
													</div>				
													<div class="col-lg-3">
																	...
																	<div class="row">
																		<div class="col-xs-12">
																		  <label><font color=red>*</font> Purchased Item Quantity</label>
																			<input type="number" class="form-control" value="0" name="pur_det_quantity" placeholder="Purchased Item Quantity">
																		</div>
																	</div>
													</div>
													<div class="col-lg-3">
																	...
																	<div class="row">
																		<div class="col-xs-12">
																		  <label><font color=red>*</font> Other Charge</label>
																			<input type="number" class="form-control" value="0" name="pur_det_oth_chr" placeholder="Other Charge">
																		</div>
																	</div>
													</div>
													<div class="col-lg-3">
																	...
																	<div class="row">
																		<div class="col-xs-12">
																		  <label><font color=red>*</font> Discount</label>
																			<input type="number" class="form-control" value="0" name="pur_det_disc" placeholder="Discount">
																		</div>
																	</div>
													</div>
													<div class="col-lg-6">
																	...
																	<div class="row">
																		<div class="col-xs-12">
																		  <label>Purchased Item Total Price</label>
																			<input type="text" class="form-control" value="0" name="pur_det_tot_price" placeholder="Purchased Item Total Price" readonly>
																		</div>
																	</div>
													</div>
							</div>
...
<a href="<?php echo '../purch_det_index/'.$row->purchase_id ?>" class="btn btn-primary btn-warning">Cancel</a></form>
</div>
</section>
