...
<form action="{{action('CustomerController@savecust')}}" method="post">
					...
					<div class="row">
						...
						<div class="col-md-6">
										<div class="row">
											...
											<div class="col-xs-6">
											  <label>Courier</label>
											  <input type="text" class="form-control" name="cust_courier" placeholder="Courier">
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-12">
											  ...
											  <select name="cust_item_cat" class="form-control select2" style="width: 100%;">
												<option selected="selected">Alabama</option>
											    <option>Alaska</option>
											    <option>California</option>
											    <option>Delaware</option>
										...
										<label>Item Description</label>
											<textarea name="cust_item_desc" class="form-control" rows="4" placeholder="Item Description" style="overflow:auto;resize:none" ></textarea>
										<br>
										...
										<div class="row">
											<div class="col-xs-4">
											  ...
											  <input type="number" class="form-control" name="other_charge" placeholder="Other Charges">
											</div>
											<div class="col-xs-4">
											...
											<div class="col-xs-4">
											  ...
											  <input type="text" class="form-control" name="tot_price" placeholder="Total Price" readonly>
											</div>
										</div>
						</div>	
					</div>
						...
						<div class="col-md-12">
										<div class="row">
											...
											<div class="col-xs-4">
											  ...
											  <input type="number" class="form-control" name="tot_paid" placeholder="Total Paid">
											</div>
											<div class="col-xs-4">
											  <label>Balance</label>
											  <input type="text" class="form-control" name="balance" placeholder="Balance" readonly>
											</div>
										</div>
						</div>			
					</div>
