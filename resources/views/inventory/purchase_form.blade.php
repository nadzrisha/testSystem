...
<form action="{{action('InventoryController@savepurchase')}}" method="post">
						...
						<div class="col-lg-12">
										<div class="row">
											<div class="col-lg-6">
											  ...
											  <input type="text" class="form-control" name="purchase_name" placeholder="Purchase Name">
											</div>
											<div class="col-lg-6">
											<label>Purchasing Date (yyyy-mm-dd)</label>
											  <div class="input-group date">
												...
												<input type="text" class="form-control pull-right" name="purchase_date" id="datepicker1">
											  </div>
											</div>
										</div>
										...
										<label>Purchase Description</label>
											<textarea name="purchase_desc" class="form-control" rows="8" placeholder="Purchase Description" style="overflow:auto;resize:none" ></textarea>
										<br>
						</div>
					</div>
					<br>
