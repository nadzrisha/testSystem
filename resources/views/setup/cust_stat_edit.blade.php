...
<body>
    ...
    <section class="content-header">
      <h1>
        Edit Customer Status Forms
      </h1>
    </section>
<section class="content">
<div class="form-group">
<form action="{{action('SetupController@update_cust_stat')}}" method="post">
<input type="hidden" name="_token" value="<?= csrf_token(); ?>" >
<input type="hidden" name="cust_stat_id" value="<?= $row->cust_stat_id ?>" >
						...
						<div class="col-md-12">
										<div class="row">
											<div class="col-lg-6">
											  ...
											  <input type="text" class="form-control" name="cust_stat_name" value="<?= $row->cust_stat_name ?>"placeholder="Customer Status Name">											  
											</div>
										</div>
						</div>
					</div>
...
<a href="<?php echo '../setup_cust_stat' ?>" class="btn btn-primary btn-warning">Cancel</a></form>
</form>
</div>
</section>
