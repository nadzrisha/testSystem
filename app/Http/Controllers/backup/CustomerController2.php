...
class CustomerController extends Controller {
	...
	public function customerformtest()
	{
		$couriername = DB::table('setup_courier')->lists('courier_name');
		$statename = DB::table('setup_state')->lists('state_name');
	    $detlocname = DB::table('setup_det_loc')->lists('det_loc_name');
		$custstatname = DB::table('setup_cust_stat')->lists('cust_stat_name');
